...
* rest-generator
** create regex factory for `path params`
** generate `query params`
** fix struct names in template generator (UserAccountRouter, UserAccountPreHandler are hardcoded)
** error handling (replace unwrap. check todo)
