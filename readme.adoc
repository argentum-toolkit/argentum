...
* rest-generator
** generate by openapi spec
** replace package name in generated code (find user_account in templates)
** generate models and responses and remove package api
** generate `path params`
** fix code duplication
** adoc documentation for argentum_res
