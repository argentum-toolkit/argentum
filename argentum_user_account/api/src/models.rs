...
impl std::str::FromStr for AnonymousRegistrationResult {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        struct IntermediateRep {
            pub anonymous_id: Vec<uuid::Uuid>,
...
//argentum-customization next line
impl SerializableBody for TestTestTest {}

impl TestTestTest {
    #[allow(clippy::new_without_default)]
    pub fn new() -> TestTestTest {
        TestTestTest {
            tst1_1: None,
            tst1_2: None,
            tst1_3: None,
...
/// Converts the TestTestTest value to the Query Parameters representation (style=form, explode=false)
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
...
/// Converts Query Parameters representation (style=form, explode=false) to a TestTestTest value
/// as specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde deserializer
impl std::str::FromStr for TestTestTest {
    type Err = String;
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        #[allow(dead_code)]
        struct IntermediateRep {
            pub tst1_1: Vec<String>,
            pub tst1_2: Vec<String>,
            pub tst1_3: Vec<models::TestTestTest2>,
        }
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(TestTestTest {
            tst1_1: intermediate_rep.tst1_1.into_iter().next(),
            tst1_2: intermediate_rep.tst1_2.into_iter().next(),
            tst1_3: intermediate_rep.tst1_3.into_iter().next(),
        })
    }
}

// Methods for converting between header::IntoHeaderValue<TestTestTest> and hyper::header::HeaderValue
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<TestTestTest> {
    type Error = String;
...
//argentum-customization next line
impl SerializableBody for TestTestTest2 {}

impl TestTestTest2 {
    #[allow(clippy::new_without_default)]
    pub fn new() -> TestTestTest2 {
        TestTestTest2 {
            tst1: None,
            tst2: None,
        }
...
/// Converts the TestTestTest2 value to the Query Parameters representation (style=form, explode=false)
/// specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde serializer
...
/// Converts Query Parameters representation (style=form, explode=false) to a TestTestTest2 value
/// as specified in https://swagger.io/docs/specification/serialization/
/// Should be implemented in a serde deserializer
impl std::str::FromStr for TestTestTest2 {
    type Err = String;
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        // Use the intermediate representation to return the struct
        std::result::Result::Ok(TestTestTest2 {
            tst1: intermediate_rep.tst1.into_iter().next(),
            tst2: intermediate_rep.tst2.into_iter().next(),
        })
    }
}

// Methods for converting between header::IntoHeaderValue<TestTestTest2> and hyper::header::HeaderValue
...
#[cfg(any(feature = "client", feature = "server"))]
impl std::convert::TryFrom<hyper::header::HeaderValue> for header::IntoHeaderValue<TestTestTest2> {
    type Error = String;
...
impl std::string::ToString for UserName {
    fn to_string(&self) -> String {
        let params: Vec<Option<String>> = vec![
            // Skipping tst in query parameter serialization
...
impl std::str::FromStr for UserName {
    ...
    fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
        ...
        #[allow(dead_code)]
        struct IntermediateRep {
            pub tst: Vec<models::TestTestTest>,
        }
