use crate::server::handler::AnonymousRegistersTrait;use crate::server::handler::AnonymousRequestsRestoreTokenTrait;use crate::server::handler::AnonymousWithTokenChangesPasswordTrait;use crate::server::handler::UserLoginsWithPasswordTrait;use crate::server::handler::UserRegistersWithPasswordTrait;use crate::server::{UserAccountPreHandler, UserAccountRouter};
...
impl ApiDiC {
    pub fn new(
        ...
        bearer_auth: Arc<BearerAuthenticator>,
            ...
            anonymous_with_token_changes_password_handler: Arc<dyn AnonymousWithTokenChangesPasswordTrait>,
