...
use crate::ui::form_data::UserRegistersWithPasswordFormData;

use crate::ui::form_data::UserRegistersWithPasswordProps;
use dioxus::prelude::*;
...
pub fn create_user_registers_with_password_web_boilerplate(
    server_url: String,
    props: UserRegistersWithPasswordProps,
) -> (impl FnMut(Event<FormData>), UserRegistersWithPasswordFormData) {
    ...
    let on_submit = {
        ...
        move |_| {
            spawn(async move {
                ...
                match res {
                    Ok(data) => match data {
                        UserRegistersWithPasswordOperationResponseEnum::Status200(r) => {
