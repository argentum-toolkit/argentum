...
use crate::ui::form_data::UserLoginsWithPasswordFormData;

use crate::ui::form_data::UserLoginsWithPasswordProps;
use dioxus::prelude::*;
...
pub fn create_user_logins_with_password_web_boilerplate(
    server_url: String,
