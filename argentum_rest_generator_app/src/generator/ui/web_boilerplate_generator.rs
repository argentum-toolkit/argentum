...
const MOD_PATH: &str = "/src/ui/web_boilerplate/mod.rs";
const MOD_TEMPLATE: &str = "ui/web_boilerplate.mod";
const ITEM_TEMPLATE: &str = "ui/web_boilerplate.item";
...
pub(crate) struct WebBoilerplateGenerator {
...
impl WebBoilerplateGenerator {
    ...
    fn generate_item(
        ...
        let file_path = format!(
            "/src/ui/web_boilerplate/{}_web_boilerplate.rs",
