...
handlebars_helper!(lower_helper: |s: String| s.to_case(Case::Lower));
handlebars_helper!(content_type_to_type_helper: |s: String| s.replace(['/', '-', '+'], "_").to_case(Case::UpperCamel));
