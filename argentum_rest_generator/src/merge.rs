        ...
        if let Some(file_path) = component_ref.file_path {
            ...
            match component {
                ...
                Some(s) => {
                    ...
                    let (mut res_spec, res_body) = collect_request_boby(b, inner_file_path.into());
        ...
        if let Some(file_path) = component_ref.file_path {
            ...
            match component {
                ...
                Some(s) => {
                    ...
                    let (mut res_spec, res_resp) = collect_response(resp, inner_file_path.into());
